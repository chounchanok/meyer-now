...
return [
    ...
    'KT_THEME_ASSETS' => [
        'favicon' => 'assets/media/logos/Meyer-Logo_web-short.png',
        'fonts' => [
    ...
    'KT_THEME_VENDORS' => [
        'datatables' => [
            'css' => [
                ...
                // 'assets/plugins/custom/datatables/dataTables.dataTables.css',
                // 'assets/plugins/custom/datatables/buttons.dataTables.css',
                // 'assets/plugins/custom/datatables/fixedHeader.dataTables.css',
                // 'assets/plugins/custom/datatables/fixedColumns.dataTables.css'
            ],
            'js' => [
                'assets/plugins/custom/datatables/datatables.bundle.js',
                // 'assets/plugins/custom/datatables/jquery-3.7.1.js',
                // 'assets/plugins/custom/datatables/dataTables.js',
                // 'assets/plugins/custom/datatables/dataTables.buttons.js',
                // 'assets/plugins/custom/datatables/buttons.dataTables.js',
                // 'assets/plugins/custom/datatables/jszip.min.js',
                // 'assets/plugins/custom/datatables/pdfmake.min.js',
                // 'assets/plugins/custom/datatables/vfs_fonts.js',
                // 'assets/plugins/custom/datatables/buttons.html5.min.js',
                // 'assets/plugins/custom/datatables/buttons.print.min.js',
                // 'assets/plugins/custom/datatables/dataTables.fixedHeader.js',
                // 'assets/plugins/custom/datatables/fixedHeader.dataTables.js',
                // 'assets/plugins/custom/datatables/dataTables.fixedColumns.js',
                // 'assets/plugins/custom/datatables/fixedColumns.dataTables.js'
            ],
        ],
        'formrepeater' => [
            'js' => [
