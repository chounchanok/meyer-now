<x-default-layout>
    ...
    @push('scripts')
        <script type="text/javascript">
            ...
            function get_column(){
                $.ajax({
                    ...
                    success: function (result) { 
                        ...
                        html += `<th rowspan="2" class="align-middle border-bottom border-end" style="min-width:100px;">Department</th>`;
                        for(var i = 0;i < result.length;i++){
                            // if(result[i].status == '0'){
                            //     html += `<th style="display: none;"></th>`;
                            // }else{
                                
                                html += `<th class="border-bottom" style="min-width:100px;position: relative;" onmouseover="getaction(${i},1);" onmouseout="getaction(${i},0);">
                                            <span class="allactive" id="allactive__${i}" >Action${i+1}</span>
                            ...
                            var resultx = '-';
                            if(result[i].start_date_real != '0000-00-00'){
                                if(result[i].end_date_real != '0000-00-00'){
                            ...
                            // if(result[i].status == '0'){
                            //     html2 += `<th style="display: none;"></th>`;
                            // }else{
                                if(i == 0){
            ...
            function getaction(i,hover){
                console.log(i);
                console.log(hover);
                $('.allactive').removeClass('active__');
                if(hover == '1'){
                    $('.hide__'+i).css('display','block');
                    $('#allactive__'+i).addClass('active__');
                }else{
