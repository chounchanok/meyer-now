        ...
        <div class="col-md-12">
            <div class="card h-xl-100">
                ...
                <div class="card-body pt-6">
                    ...
                    <div class="table-responsive hidden" style="position: relative;">
                        <!--begin::Menu wrapper-->
        ...
        <script type="text/javascript">
            ...
            function search_group(){
                $("#kt_datatable_dom_positioning").DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax": {
                        "url": "{{ url(Request::segment(1).'/table_allgrade_getdata') }}",
                        "type": 'POST',  
                        "data": {
                            "_token": "{{ csrf_token() }}",
            ...
            $("#add_action").submit(function(e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ url(Request::segment(1).'/setting/manageGrade/add') }}",
                    headers: {
            ...
            function change_active(e,id){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ url(Request::segment(1)."/grade_change_active") }}',
                    dataType: 'json',
                    data : { 
                        "_token": "{{ csrf_token() }}",
                        "id":$(e).attr('data-id'),
