<x-default-layout>
                                ...
                                <div class="card-body py-3">
                                    <div class="row justify-content-between mb-2">
                                        ...
                                        <div class="col-sm-auto text-end">
                                            <h1 class="badge badge-light-success text-center py-2 mb-0 Overall_daily_percent">0.000%</h1>
                                        </div>
                                    </div>
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-sm-auto text-end">
                                            <h1 class="badge badge-light-warning text-danger text-center py-2 mb-0 percent_department_daily_percent">0.000%</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-none rounded-3 mb-3">
                                ...
                                <div class="card-body py-3">
                                    <div class="row justify-content-between mb-2">
                                        ...
                                        <div class="col-sm-auto text-end">
                                            <h1 class="badge badge-light-success text-center py-2 mb-0 Overall_Dailymonthly_percent">0.000%</h1>
                                        </div>
                                    </div>
                                    <div class="row justify-content-between">
                                        <div class="col-sm-auto">
                                        ...
                                        <div class="col-sm-auto text-end">
                                            <h1 class="badge badge-light-warning text-danger text-center py-2 mb-0 percent_department_Dailymonthly_percent">0.000%</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-none rounded-3 p-3">
                                <div class="d-flex flex-stack">  
                                    ...
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">                   
                                        <div class="flex-grow-1 me-2">
                                            <p class="text-gray-800 small fw-normal mb-0">All employees</p>
                                            <h4 class="text-black fw-bold d-block text-end mb-0 data_all"></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-none rounded-3 p-3 bg-light-secondary">
                                <div class="d-flex flex-stack">  
                                    ...
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">                   
                                        <div class="flex-grow-1 me-2">
                                            <p class="text-gray-800 small fw-normal mb-0">Wait for approval</p>
                                            <h4 class="text-black fw-bold d-block text-end mb-0 data_in"></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-none rounded-3 p-3 bg-light-danger">
                                <div class="d-flex flex-stack">  
                                    ...
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">                   
                                        <div class="flex-grow-1 me-2">
                                            <p class="text-gray-800 small fw-normal mb-0">Reject</p>
                                            <h4 class="text-black fw-bold d-block text-end mb-0 data_reject"></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-none rounded-3 p-3 bg-light-success">
                                <div class="d-flex flex-stack">  
                                    ...
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">                   
                                        <div class="flex-grow-1 me-2">
                                            <p class="text-gray-800 small fw-normal mb-0">Approved</p>
                                            <h4 class="text-black fw-bold d-block text-end mb-0 data_finish"></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="kt_datatable_dom_positioning" class="table table-striped rounded">
                                <thead class="table-light">
                                    <tr class="fw-bold fs-6 text-gray-800 px-7">
                                        ...
                                        <th rowspan="2" style="min-width:150px;">Inc. % Proposed by Mgr.</th>
    ...
    <div class="modal fade" tabindex="-1" id="update_grade_p">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-sm-12">
                            ...
                            >
                            <select class="form-select form-select-solid" id="change_position_old" name="change_position_old" data-control="select2" data-dropdown-parent="#update_grade_p" data-placeholder="-Choose-">
...
<script type="text/javascript">
    ...
    function search_data(){
        ...
        var otable = $("#kt_datatable_dom_positioning").DataTable({
            ...
            "lengthMenu": [[10, 100,500, 1000, 2000], [10, 100,500, 1000, 2000]],
            searchDelay: 500,
            processing: true,
            serverSide: true,
            scrollY: true,
                ...
                if(hidden_budget_grade_name[i].value == e.value){
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $('#final_by_md_gm_amount'+id).val(result.final_by_md_gm_amount_nocomma);
                    ...
                    if(result.total_Daily || result.total_Monthly || result.total_Daily_Monthly){
                        ...
                        Monthly += `
                            <tr class="align-middle">
                                ...
                                <td class="text-end">${(result.total_Monthly.current_salary_wage>0?number_format(result.total_Monthly.current_salary_wage,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.L800_avg_wage_mwa>0?number_format(result.total_Monthly.L800_avg_wage_mwa,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.salary_wage_calculation>0?number_format(result.total_Monthly.salary_wage_calculation,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.current_salary_wage_month>0?number_format(result.total_Monthly.current_salary_wage_month,2):'')}</td>
                                <td class="text-center">${(result.total_Monthly.company_suggested_percent>0?number_format(result.total_Monthly.company_suggested_percent,2):'')}%</td>
                                <td class="text-end">${(result.total_Monthly.company_suggested_amount>0?number_format(result.total_Monthly.company_suggested_amount,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.company_suggested_new_basic>0?number_format(result.total_Monthly.company_suggested_new_basic,2):'')}</td>
                                <td></td>
                                <td class="text-center">${(result.total_Monthly.inc_percent_proposed>0?number_format(result.total_Monthly.inc_percent_proposed,2):'')}%</td>
                                <td class="text-end">${(result.total_Monthly.inc_amount_proposed>0?number_format(result.total_Monthly.inc_amount_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.new_basic_wage_proposed>0?number_format(result.total_Monthly.new_basic_wage_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Monthly.new_salary_wage_month>0?number_format(result.total_Monthly.new_salary_wage_month,2):'')}</td>
                            </tr>
                        `;
                        ...
                        Daily += `
                            <tr class="align-middle">
                                ...
                                <td class="text-end">${(result.total_Daily.current_salary_wage>0?number_format(result.total_Daily.current_salary_wage,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.L800_avg_wage_mwa>0?number_format(result.total_Daily.L800_avg_wage_mwa,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.salary_wage_calculation>0?number_format(result.total_Daily.salary_wage_calculation,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.current_salary_wage_month>0?number_format(result.total_Daily.current_salary_wage_month,2):'')}</td>
                                <td class="text-center">${(result.total_Daily.company_suggested_percent>0?number_format(result.total_Daily.company_suggested_percent,2):'')}%</td>
                                <td class="text-end">${(result.total_Daily.company_suggested_amount>0?number_format(result.total_Daily.company_suggested_amount,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.company_suggested_new_basic>0?number_format(result.total_Daily.company_suggested_new_basic,2):'')}</td>
                                <td></td>
                                <td class="text-center">${(result.total_Daily.inc_percent_proposed>0?number_format(result.total_Daily.inc_percent_proposed,2):'')}%</td>
                                <td class="text-end">${(result.total_Daily.inc_amount_proposed>0?number_format(result.total_Daily.inc_amount_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.new_basic_wage_proposed>0?number_format(result.total_Daily.new_basic_wage_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Daily.new_salary_wage_month>0?number_format(result.total_Daily.new_salary_wage_month,2):'')}</td>
                            </tr>
                        `;
                        ...
                        All += `
                            <tr class="align-middle">
                                ...
                                <td class="text-end">${(result.total_Daily_Monthly.current_salary_wage>0?number_format(result.total_Daily_Monthly.current_salary_wage,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.L800_avg_wage_mwa>0?number_format(result.total_Daily_Monthly.L800_avg_wage_mwa,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.salary_wage_calculation>0?number_format(result.total_Daily_Monthly.salary_wage_calculation,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.current_salary_wage_month>0?number_format(result.total_Daily_Monthly.current_salary_wage_month,2):'')}</td>
                                <td class="text-center">${(result.total_Daily_Monthly.company_suggested_percent>0?number_format(result.total_Daily_Monthly.company_suggested_percent,2):'')}%</td>
                                <td class="text-end">${(result.total_Daily_Monthly.company_suggested_amount>0?number_format(result.total_Daily_Monthly.company_suggested_amount,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.company_suggested_new_basic>0?number_format(result.total_Daily_Monthly.company_suggested_new_basic,2):'')}</td>
                                <td></td>
                                <td class="text-center">${(result.total_Daily_Monthly.inc_percent_proposed>0?number_format(result.total_Daily_Monthly.inc_percent_proposed,2):'')}%</td>
                                <td class="text-end">${(result.total_Daily_Monthly.inc_amount_proposed>0?number_format(result.total_Daily_Monthly.inc_amount_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.new_basic_wage_proposed>0?number_format(result.total_Daily_Monthly.new_basic_wage_proposed,2):'')}</td>
                                <td class="text-end">${(result.total_Daily_Monthly.new_salary_wage_month>0?number_format(result.total_Daily_Monthly.new_salary_wage_month,2):'')}</td>
                            </tr>
                        `;
    ...
    function update_final_by_md_gm_amount(id){
        ...
        var cal_service = parseFloat(service_days)/365;
        ...
        console.log(cal);
        $('#percent_proposed'+id).val(number_format2(cal,4));

        var cal2 = ((parseFloat(bsalaryw)*parseFloat(cal))/100)*parseFloat(cal_service);
        $('.amount_proposed'+id).html(number_format(cal2,2));

        var cal3 = (parseFloat(bsalaryw)+parseFloat(cal2));
        $('.salary_new'+id).html(number_format(cal3,2));
        $('#salary_new'+id).val(cal3);

        if(search_month_day == "1"){
            var salary_month_new = cal3*26;
        }else{
            var salary_month_new = cal3;
        }
        $('.salary_month_new'+id).html(number_format(salary_month_new,2));
        $('#salary_month_new'+id).val(salary_month_new);
        ...
        $.ajax({
            ...
            success: function (result) {
                $('.percent_proposed_old'+id).html(number_format2(result.percent_proposed_old,4)+'% &#62; ');
                $('#percent_proposed'+id).val(number_format2(cal,4));
                $('.percent_proposed'+id).html(number_format2(cal,4)+'%');
            }
        });
    }
    //////////////////////////////
    ...
    function change_position_p(){
        ...
        if($('#change_position_old').val() == "0"){
            ...
            if($('#change_position_new').val() == "0"){
                ...
                for(var i = 0;i < hidden_budget_std.length;i++){
                    if(hidden_budget_grade_name[i].value == 'P' || hidden_budget_grade_name[i].value == 'AR' || hidden_budget_grade_name[i].value == 'U'){
                        $('#percent_proposed'+id).val(hidden_budget_std[i].value);
                        $('.percent_proposed'+id).html(hidden_budget_std[i].value+'%');
                        var hidden_budget_std2 = hidden_budget_std[i].value;
                            ...
                            success: function (result2) {
                                ...
                                $.ajax({
                                    ...
                                    data : { 
                                        "_token": "{{ csrf_token() }}",
                                        "id":id,
                                        "grade_proposed":hidden_budget_grade_name[i].value,
                                        "percent_proposed":hidden_budget_std2
                                    },
                                    success: function (result) {
                                        
                                        $('#id_gmgr'+id).attr("class", "form-select form-select-sm selectG mb-2 gradeP");
                                        $('.changecolor'+id).css("color", "var(--bs-primary)");
                                        $('.changecolor'+id).text(hidden_budget_grade_name[i].value);
                                        $('.grade_proposed_old'+id).html(result.grade_proposed_old+' &#62; ');
                                        $('.percent_proposed_old'+id).html(result.percent_proposed_old+'% &#62; ');
                                        $('.amount_proposed'+id).html(result.amount_proposed);
                                        $('.salary_new'+id).html(result.salary_new);
