<x-default-layout>
            ...
            <div class="card h-xl-100">
                ...
                <div class="card-body pt-6">
                    ...
                    <div class="accordion accordion-icon-collapse  mb-3" id="kt_accordion_3">
                        <div class="">
                            <div class="accordion-header d-flex collapsed mb-3" data-bs-toggle="collapse" data-bs-target="#kt_accordion_3_item_2">
                                <div class="row g-3" style="width: 100%;">
                                    <div class="col-6 col-md-2  d-flex" style="align-items: center;width: 108px;">
                                    ...
                                    <div class="col-12 col-sm-2">
                                        <div class="card shadow-none rounded-3 p-3 " style="padding: 0px !important;">
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div
                                                    class="d-flex align-items-center flex-row-fluid flex-wrap" style="font-size: 11px;"
                                                >
                                    ...
                                    <div class="col-12 col-sm-2" style="width: 159px;">
                                    ...
                                    <div class="col-12 col-sm-2">
                                        <div class="card shadow-none rounded-3 p-3 bg-light-secondary " style="padding: 0px !important;">
                                            <div class="d-flex flex-stack">
                                                <div class="symbol symbol-40px me-3">
                                                    <div
                                                        class="symbol-label fs-2 fw-semibold bg-primary"
                                                    >
                                                        <i
                                                            class="ki-outline ki-loading fs-2 text-white"
                                                        ></i>
                                                    </div>
                                                </div>
                                                <div
                                                ...
                                                >
                                                    <div class="flex-grow-1 me-2" style="display: flex;align-items: center;justify-content: space-between;">
                                                        ...
                                                        <h4
                                                            class="text-black fw-bold d-block text-end mb-0 submit_to_dmgm"
                                                            style="padding-right: 10px;"
                                                        >
                                    ...
                                    <div class="col-12 col-sm-2" style="width: 115px;">
                                    ...
                                    <div class="col-12 col-sm-2" style="width: 155px;">
                                        ...
                                        <div class="card shadow-none rounded-3 p-3 bg-light-secondary " style="padding: 0px !important;">
                                            <div class="d-flex flex-stack">
                                                <div class="symbol symbol-40px me-3">
                                                    ...
                                                    >
                                                        <i
                                                            class="ki-outline ki-send fs-2 text-white"
                                                        ></i>
                                                    </div>
                                                </div>
                                                <div
                                                ...
                                                >
                                                    <div class="flex-grow-1 me-2" style="display: flex;align-items: center;justify-content: space-between;">
                                                        ...
                                                        <h4
                                                            class="text-black fw-bold d-block text-end mb-0 submit_to_approve_hr"
                                                            style="padding-right: 10px;"
                                                        >
                                    ...
                                    <div class="row g-3 mb-3" style="font-size: 14px;">
                                        ...
                                        <div class="col-12 col-sm-1" style="font-size: 14px;">
                                            ...
                                            <select class="form-select myLike" data-control="select2" id="search_status" name="search_status" data-placeholder="-Select-" onchange="destroy_table();">
                                                <option value="all">All</option>
                                                <option value="-1">Submit to DM/GM</option>
                    ...
                    <div class=" position-relative">
                        ...
                        <div style="position:absolute;top:0;left:0;z-index:99;">
                            <div class="d-inline-flex" style="font-size: 14px !important;">
                                <button type="button" class="btn btn-light-primary rotate mb-3 p-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px" style="font-size: 14px !important;">
                                    Action
                            ...
                            <div class="d-inline-flex" style="font-size: 14px !important;">
                                <button type="button" class="btn btn-light rotate mb-3 p-2 ps-3 rounded-pill" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px" style="font-size: 14px !important;">
                                    Display
                                    <i class="ki-duotone ki-down fs-3 rotate-180 ms-3 me-0"></i>
                                </button>
                                <!--end::Toggle-->
                            ...
                            <div class="d-inline-flex">
                                <button type="button" class="btn btn-success rotate p-2 ps-3 rounded-pill" style="font-size:14px;" onclick="freeze();"><i class="bi bi-floppy fs-5"></i>
                                    {{Auth::user()->orisoft_code=="013591"?'Submit to GM/DM':'Submit to HR'}}
                                </button>
                            </div>
                            <div class="d-inline-flex">
                            ...
                            <!-- <div class="d-inline-flex bg-light-secondary" style="font-size: 14px !important;">
                                <div class="row"> -->
                                <!-- <div class="col-12 col-sm-2">
                                    <div class="card shadow-none rounded-3 p-3 " style="padding: 0px !important;">
                                        <div class="d-flex flex-stack">
                            ...
                            >
                                <thead class="table-light">
                                    <tr class="fw-bold fs-6 text-gray-800 px-7">
                                        ...
                                        <th class="text-center" rowspan="2">Join date</th>
                                        <th class="text-center" rowspan="2">Service period(days)</th>
                                        ...
                                        <th class="text-center bg-success" style="color:white;" rowspan="2" style="min-width:150px;">Inc. % Proposed by DM/GM</th>
                                        <th class="text-center bg-success" style="color:white;" rowspan="2">Inc. Amount Proposed by DM/GM</th>
                                        <th class="text-center bg-success" style="color:white;" rowspan="2">New Basic/Wage Proposed by DM/GM</th>
                                        <th class="text-center bg-success" style="color:white;" rowspan="2">New B. Salary/Wage by DM/GM (THB/Mth)</th>
                                        ...
                                        <th class="text-center" rowspan="2" style="min-width:100px;">Action</th>
                                    </tr>
                                    <tr class="fw-bold fs-6 text-gray-800 px-7">
                        ...
                        <table class="table table-striped table-rounded">
                            <thead class="table-light">
                                <tr class="text-center fw-bold align-middle">
                                    <th>Monthly/Daily</th>
                                    <th class="bg-light-warning" id="footer-vis-click-29">Current B. Salary/Wage</th>
                                    <th class="bg-light-warning" id="footer-vis-click-30">L800 AVG. Wage of Min.Wage Adjusted</th>
                                    <th class="bg-light-warning" id="footer-vis-click-31">B. Salary/Wage for Calculation</th>
                                    <th class="bg-light-warning" id="footer-vis-click-32">Current B. Salary/Wage (THB/Mth)</th>
                                    <th class="bg-light-warning" id="footer-vis-click-33">Company Suggested (%)</th>
                                    <th class="bg-light-warning" id="footer-vis-click-34">Company Suggestged (Amount)</th>
                                    <th class="bg-light-warning" id="footer-vis-click-35">Company Suggestged New Basic</th>
                                    <th></th>
                                    <th class="bg-primary" id="footer-vis-click-37" style="color:white;">Inc. % Proposed by Mgr.</th>
                                    <th class="bg-primary" id="footer-vis-click-38" style="color:white;">Inc. Amount Proposed by Mgr.</th>
                                    <th class="bg-primary" id="footer-vis-click-39" style="color:white;">New Basic/Wage Proposed by Mgr.</th>
                                    <th class="bg-primary" id="footer-vis-click-40" style="color:white;">New B. Salary/Wage (THB/Mth)</th>

                                    <th class="bg-success" style="color:white;">Inc. % Proposed by DM/GM</th>
                                    <th class="bg-success" style="color:white;">Inc. Amount Proposed by DM/GM</th>
                                    <th class="bg-success" style="color:white;">New Basic/Wage Proposed by DM/GM</th>
                                    <th class="bg-success" style="color:white;">New B. Salary/Wage by DM/GM (THB/Mth)</th>
                                    <th class="bg-success" id="footer-vis-click-41" style="color:white;">Final by DM/GM (Amount)</th>
                                </tr>
                            </thead>
    ...
    <div class="modal fade" tabindex="-1" id="approveModal_approve3">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-3">
                    <h3 class="modal-title">{{ __('Confirm second approval') }}</h3>
                ...
                <div class="modal-body text-center">
                    <h1 class="ki-solid ki-check-circle text-success fs-5r"></h1>
                    <p>{{ __('Confirm second approval') }} ?</p>
                </div>

                <div class="modal-footer justify-content-center py-3">
                    <button type="button" class="btn btn-outline btn-outline-dark rounded-pill btn-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success  rounded-pill btn-sm" data-bs-dismiss="modal" onclick="approveModal_update_approve3();">Confirm</button>
                    <input type="hidden" id="approveModal_id_approve3" value="">
                </div>
            </div>
        </div>
    </div>
    
    <div class="modal fade" tabindex="-1" id="rejectModal_approve3">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-3">
                    <h3 class="modal-title">{{ __('Confirm reject salary') }}</h3>
                ...
                <div class="modal-footer justify-content-center py-3">
                    <button type="button" class="btn btn-outline btn-outline-dark rounded-pill btn-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-danger  rounded-pill btn-sm" data-bs-dismiss="modal" onclick="rejectModal_update_approve3();">Confirm Reject</button>
                    <input type="hidden" id="rejectModal_id_approve3" value="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-sm-6 showhide_p" style="margin-top: 30px;">
                        ...
                        <div class="row col-12 col-sm-9">
                            <div class="col-12 col-sm-4 mt-4">
                                ...
                                <select class="form-select form-select-solid" id="jd_position" name="jd_position" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-">
                                    @foreach ($position_jd as $key => $val)
    ...
    <script type="text/javascript">
        ...
        function search_data(){
            ...
            var otable = $("#kt_datatable_dom_positioning").DataTable({
                ...
                ajax: {
                    url: "{{ url(Request::segment(1).'/table_salary_getdata_review') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                ...
                columns: [
                    ...
                    { data: "incpctmgr_gmdm" },
                    { data: "incamount_gmdm",className: 'text-right'  },
                    { data: "newbwage_gmdm",className: 'text-right'  },
                    { data: "newbsalary_gmdm",className: 'text-right'  },
                    { data: "finaldmgm_edit",className: 'text-right'  },
                    ...
                    if(hidden_budget_grade_name[i].value == e.value){
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                $('.percent_proposed_old_gmdm'+id).html(result.percent_proposed_gmdm+'% &#62; ');
                                $('.amount_proposed_gmdm'+id).html(result.amount_proposed_gmdm);
                                $('.salary_new_gmdm'+id).html(result.salary_new_gmdm);
                                $('.salary_month_new_gmdm'+id).html(result.salary_month_new_gmdm);
                                
                                $('#final_by_md_gm_amount'+id).val(result.final_by_md_gm_amount);
                                $('#finaldmgm_hide'+id).val(result.final_by_md_gm_amount_nocomma);
                                if(e.value != 'P' || e.value != 'CD'){
                                    // $('#remark_grade'+id).val('');
                                }
...
3.3 Personality Traits`);
        ...
        function change_class_input(e,i,id) {
            ...
            var hidden_budget_range_start = $('.hidden_budget_range_start'); 
            var hidden_budget_range_end = $('.hidden_budget_range_end'); 
            var hidden_budget_grade_name = $('.hidden_budget_grade_name'); 
            var hidden_budget_std = $('.hidden_budget_std');
            var hidden_budget_std2 = 0;
            var hidden_budget_grade_name_value = '';
            for(var i = 0;i < hidden_budget_std.length;i++){
                if(hidden_budget_grade_name[i].value == $('#id_gmgr'+id).val()){
                    if(parseFloat(e.value) < parseFloat(hidden_budget_range_start[i].value) || parseFloat(e.value) > parseFloat(hidden_budget_range_end[i].value)){
                        $('#percent_proposed'+id).css('background-color','rgb(255 211 211)');
                    }else{
                        $('#percent_proposed'+id).css('background-color','');
                    }
                }
            }
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/update_percent_proposed_input_gmdm") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "id":id,
                ...
                success: function (result) {
                    ...
                    if($('#id_gmgr'+id).val() != 'P' || $('#id_gmgr'+id).val() != 'CD'){
                        // $('#remark_grade'+id).val('');
                    }
        ...
        function all_detail(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/all_detail_review") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                ...
                success: function (result) {
                    if(result){
                        ...
                        if(result.total_Daily || result.total_Monthly || result.total_Daily_Monthly){
                            ...
                            Monthly += `
                                <tr class="align-middle">
                                    ...
                                    <td></td>
                                    <td class="bg-light-primary text-center">${(result.total_Monthly.inc_percent_proposed>0?number_format(result.total_Monthly.inc_percent_proposed,2):'0.00')}%</td>
                                    <td class="bg-light-primary text-end">${(result.total_Monthly.inc_amount_proposed>0?number_format(result.total_Monthly.inc_amount_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Monthly.new_basic_wage_proposed>0?number_format(result.total_Monthly.new_basic_wage_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Monthly.new_salary_wage_month>0?number_format(result.total_Monthly.new_salary_wage_month,2):'0.00')}</td>
                                    
                                    <td class="bg-light-success text-center">${(result.total_Monthly.percent_proposed_gmdm>0?number_format(result.total_Monthly.percent_proposed_gmdm,2):'0.00')}%</td>
                                    <td class="bg-light-success text-end">${(result.total_Monthly.amount_proposed_gmdm>0?number_format(result.total_Monthly.amount_proposed_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Monthly.salary_new_gmdm>0?number_format(result.total_Monthly.salary_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Monthly.salary_month_new_gmdm>0?number_format(result.total_Monthly.salary_month_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end showhide_total_Monthly">${(result.total_Monthly.final_by_md_gm_amount>0?number_format(result.total_Monthly.final_by_md_gm_amount,2):'0.00')}</td>
                                </tr>
                            `;
                            ...
                            Daily += `
                                <tr class="align-middle">
                                    ...
                                    <td></td>
                                    <td class="bg-light-primary text-center">${(result.total_Daily.inc_percent_proposed>0?number_format(result.total_Daily.inc_percent_proposed,2):'0.00')}%</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily.inc_amount_proposed>0?number_format(result.total_Daily.inc_amount_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily.new_basic_wage_proposed>0?number_format(result.total_Daily.new_basic_wage_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily.new_salary_wage_month>0?number_format(result.total_Daily.new_salary_wage_month,2):'0.00')}</td>

                                    <td class="bg-light-success text-center">${(result.total_Daily.percent_proposed_gmdm>0?number_format(result.total_Daily.percent_proposed_gmdm,2):'0.00')}%</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily.amount_proposed_gmdm>0?number_format(result.total_Daily.amount_proposed_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily.salary_new_gmdm>0?number_format(result.total_Daily.salary_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily.salary_month_new_gmdm>0?number_format(result.total_Daily.salary_month_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end showhide_total_Daily">${(result.total_Daily.final_by_md_gm_amount>0?number_format(result.total_Daily.final_by_md_gm_amount,2):'0.00')}</td>
                                </tr>
                            `;
                            ...
                            All += `
                                <tr class="align-middle">
                                    ...
                                    <td></td>
                                    <td class="bg-light-primary text-center">${(result.total_Daily_Monthly.inc_percent_proposed>0?number_format(result.total_Daily_Monthly.inc_percent_proposed,2):'0.00')}%</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily_Monthly.inc_amount_proposed>0?number_format(result.total_Daily_Monthly.inc_amount_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily_Monthly.new_basic_wage_proposed>0?number_format(result.total_Daily_Monthly.new_basic_wage_proposed,2):'0.00')}</td>
                                    <td class="bg-light-primary text-end">${(result.total_Daily_Monthly.new_salary_wage_month>0?number_format(result.total_Daily_Monthly.new_salary_wage_month,2):'0.00')}</td>
                                    
                                    <td class="bg-light-success text-center">${(result.total_Daily_Monthly.percent_proposed_gmdm>0?number_format(result.total_Daily_Monthly.percent_proposed_gmdm,2):'0.00')}%</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily_Monthly.amount_proposed_gmdm>0?number_format(result.total_Daily_Monthly.amount_proposed_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily_Monthly.salary_new_gmdm>0?number_format(result.total_Daily_Monthly.salary_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end">${(result.total_Daily_Monthly.salary_month_new_gmdm>0?number_format(result.total_Daily_Monthly.salary_month_new_gmdm,2):'0.00')}</td>
                                    <td class="bg-light-success text-end showhide_total_Daily_Monthly">${(result.total_Daily_Monthly.final_by_md_gm_amount>0?number_format(result.total_Daily_Monthly.final_by_md_gm_amount,2):'0.00')}</td>
                                </tr>
                            `;
                        ...
                        $('.data_in').html(parseFloat(result.data_all)-parseFloat(result.submit_to_dmgm));
                        ...
                        if(result.submit_to_dmgm >= 0){
                            $('.submit_to_dmgm').html(result.submit_to_dmgm);
                        }
                        if(result.submit_to_approve_hr >= 0){
                            $('.submit_to_approve_hr').html(result.submit_to_approve_hr);
                        }
                        ...
                        $('.finaldmgm_hide').each(function(key, value) {
                            if($('.grade_code_hide')[key].value == 'L800'){
                                if(this.value){
        ...
        function set_approveModal_id_approve3(id){
            $('#approveModal_id_approve3').val(id);
        }
        function set_rejectModal_id_approve3(id){
            $('#rejectModal_id_approve3').val(id);
        }
        ...
        function approveModal_update(){
            ...
            $.ajax({
                ...
                success: function (result) { 
                    ...
                    $('.position_description'+approveModal_id).text(result.position_description);
                    all_detail();

                    $('.set_status'+approveModal_id).removeClass('bg-light-success');
                    $('.set_status'+approveModal_id).removeClass('text-success');
                    $('.set_status'+approveModal_id).addClass('bg-success');
                    $('.set_status'+approveModal_id).addClass('text-light');
                    // evaluate_get_all();
                }
            });
        }
        function rejectModal_update(){
            ...
            $.ajax({
                ...
                success: function (result) { 
                    ...
                    $('.position_description'+rejectModal_id).text(result.position_description);
                    destroy_table();

                    $('.set_status'+rejectModal_id).removeClass('bg-light-danger');
                    $('.set_status'+rejectModal_id).removeClass('text-danger');
                    $('.set_status'+rejectModal_id).addClass('bg-danger');
                    $('.set_status'+rejectModal_id).addClass('text-light');
                    // evaluate_get_all();
                }
            });
        }
                    ...
                    success: function (result) { 
                        $('.checkbox-select').each(function() {
                            if(this.checked == true){
                                ...
                                $('.set_status'+this.value).removeClass('bg-light-success');
                                $('.set_status'+this.value).removeClass('text-success');
                                $('.set_status'+this.value).addClass('bg-success');
                                $('.set_status'+this.value).addClass('text-light');
                                // $('.position_description'+this.value).text(result.position_description);
                            }                
                        });
                        destroy_table();
                        // all_detail();
                    ...
                    success: function (result) { 
                        $('.checkbox-select').each(function() {
                            if(this.checked == true){
                                ...
                                $('.set_status'+this.value).removeClass('bg-light-danger');
                                $('.set_status'+this.value).removeClass('text-danger');
                                $('.set_status'+this.value).addClass('bg-danger');
                                $('.set_status'+this.value).addClass('text-light');
                                // $('.position_description'+this.value).text(result.position_description);
                            }                
                        });
        ...
        function approveModal_update_approve3(){
            var approveModal_id = $('#approveModal_id_approve3').val();
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/approve_salary_approve3") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "id":approveModal_id,
        ...
        function rejectModal_update_approve3(){
            var rejectModal_id = $('#rejectModal_id_approve3').val();
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/approve_salary_approve3") }}',
                dataType: 'json',
        ...
        function update_final_by_md_gm_amount(id,Daily){
            var search_month_day = $('#search_month_day').val();
            var final_by_md_gm_amount = $('#final_by_md_gm_amount'+id).val();
            final_by_md_gm_amount = final_by_md_gm_amount.replace(",", "");
            // $('#final_by_md_gm_amount'+id).val(final_by_md_gm_amount);

            var bsalaryw = $('#bsalaryw'+id).val();
            var salary_month_old = $('#salary_month_old'+id).val();

            var service_days = $('#service_days'+id).val();
            var cal_service = service_days;

            
            if(Daily == "1"){
                var cal = (((parseFloat(final_by_md_gm_amount)-parseFloat(salary_month_old))*100)/parseFloat(salary_month_old))/parseFloat(cal_service);
            }else{
                var cal = (((parseFloat(final_by_md_gm_amount)-parseFloat(bsalaryw))*100)/parseFloat(bsalaryw))/parseFloat(cal_service);
            }
            console.log(final_by_md_gm_amount);
            console.log(bsalaryw);
            console.log(salary_month_old);
            console.log(cal_service);
            console.log(cal);
            $('#percent_proposed_old_gmdm'+id).val(number_format2(cal,4));

            var cal2 = ((parseFloat(bsalaryw)*parseFloat(cal))/100)*parseFloat(cal_service);
            $('.amount_proposed_gmdm'+id).html(number_format(cal2,2));

            
            if(Daily == "1"){
                var cal3 = Math.round((parseFloat(bsalaryw)+parseFloat(cal2)));
                $('.salary_new_gmdm'+id).html(number_format(cal3,2));
                $('#salary_new_gmdm'+id).val(cal3);
                console.log(cal3);
                var salary_month_new = Math.round(cal3*26);
            }else{
                var cal3 = (parseFloat(bsalaryw)+parseFloat(cal2));
                $('.salary_new_gmdm'+id).html(number_format(cal3,2));
                $('#salary_new_gmdm'+id).val(cal3);
                console.log(cal3);
                var salary_month_new = cal3;
            }
            $('.salary_month_new_gmdm'+id).html(number_format(salary_month_new,2));
            $('#salary_month_new_gmdm'+id).val(salary_month_new);
            ...
            $.ajax({
                ...
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "id":id,
                    "percent_proposed":cal,
                    "amount_proposed":cal2,
                    "salary_new":cal3,
                ...
                success: function (result) {
                    // $('.percent_proposed_old_gmdm'+id).html(number_format2(result.percent_proposed_old,4)+'% &#62; ');
                    // $('#percent_proposed_old_gmdm'+id).val(number_format2(cal,4));
                    $('.percent_proposed_old_gmdm'+id).html(number_format2(cal,4)+'%');
                    $('#finaldmgm_hide'+id).val(final_by_md_gm_amount);
                    console.log('result.freeze_to_gmdm_edit = '+result.freeze_to_gmdm_edit);
                    // if(result.freeze_to_gmdm_edit == 1){
                    ...
                    $('#final_by_md_gm_amount'+id).removeClass('bg-light-success');
                    $('#final_by_md_gm_amount'+id).removeClass('text-success');
                    $('#final_by_md_gm_amount'+id).addClass('bg-success');
                    $('#final_by_md_gm_amount'+id).addClass('text-light');
                    // $('#final_by_md_gm_amount'+id).css('background-color','green !important');
                }
            });
        }
        //////////////////////////////
        ...
        function checknumber_final(ele,id,text,e){
            e = e || window.event;
            ...
            if (e.keyCode == 13)
            {
                $.ajax({
                    type: 'POST',
                    url: '{{ url(Request::segment(1)."/update_final_by_md_gm_amount_enter") }}',
                    dataType: 'json',
                    data : { 
                        "_token": "{{ csrf_token() }}",
                        "id":id,
                                ...
                                success: function (result2) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (result) {
                                            ...
                                            if(hidden_budget_grade_name_value != 'P' || hidden_budget_grade_name_value != 'CD'){
                                                // $('#remark_grade'+id).val('');
                                            }
                                            console.log('id_gmgr3 = '+id_gmgr);
                                            $('.change_class_info'+id).css("display", "");
                                            $('#percent_proposed'+id).css("background", "");
                                            Swal.fire({
                                                title: "Update Success",
        ...
        function get_eva(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/get_eva_salary_review") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "search_division":$('#search_division').val(),
        ...
        function get_division_first(){
            console.log('get_division_first :3');
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/get_division_review_salary") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "pagenow":'2',
        ...
        function get_department_first(){
            ...
            // }else{
                $.ajax({
                    type: 'POST',
                    url: '{{ url(Request::segment(1)."/get_department_review_salary") }}',
                    dataType: 'json',
                    data : { 
                        "_token": "{{ csrf_token() }}",
                        "search_division":$('#search_division').val(),
        ...
        function get_section_first(){
            ...
            // }else{
                $.ajax({
                    type: 'POST',
                    url: '{{ url(Request::segment(1)."/get_section_review_salary") }}',
                    dataType: 'json',
                    data : { 
                        "_token": "{{ csrf_token() }}",
                        "search_division":$('#search_division').val(),
        ...
        function freeze(){
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/check_salary_null_approve_hr") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                    "search_division":$('#search_division').val(),
                    ...
                    if(result.count > 0){
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    type: 'POST',
                                    url: '{{ url(Request::segment(1)."/freeze_to_approve_hr") }}',
                                    dataType: 'json',
                                    data : { 
                                        "_token": "{{ csrf_token() }}",
                                        "search_division":$('#search_division').val(),
        ...
        function bell_curve_detail(){
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/chart_pa_grade_dmgm") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
