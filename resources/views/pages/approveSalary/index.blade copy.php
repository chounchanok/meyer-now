<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('approveSalary.index') }}
    @endsection
                                    ...
                                    <table id="kt_datatable_dom_positioning" class="table table-striped rounded">
                                        <thead class="table-light">
                                            <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                ...
                                                <th rowspan="2" style="min-width:100px;width:100px;">{{__('Emp. no.')}}</th>
                                                <th rowspan="2">{{__('Emp. Name')}}</th>
                                                ...
                                                <th rowspan="2">{{__('Form')}}</th>
                                                <th rowspan="2">{{__('Evaluator')}} {{$previousYear}}</th>
                                                ...
                                                <th rowspan="2" style="min-width:100px;">Inc. % Proposed by Mgr.</th>
                                                ...
                                                <th rowspan="2">{{__('Remark')}}(P,AR,U)</th>
                            ...
                            <div class="tableMobile" style="display:none;">
                                ...
                                <div class="overflow-y overflow-auto" style="height:50vh">
                                    <div class="card p-5 shadow-none border-gray-300 mb-3">
                                        ...
                                        <p class="mb-3 text-black">
                                            <span class="small text-gray-800">Status: </span><span class="badge badge-light-success">Status</span>
                                        </p>
                                    </div>
                                ...
                                <!-- <div class="table-responsive">
                                    <table id="kt_datatable_dom_positioning2" class="table table-striped rounded">
                                        <thead class="table-light">
                                            <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                <th><input type="checkbox" name="select-all2" id="select-all2" ></th>
                                                <th style="min-width:100px;width:100px;">Emp. no.</th>
                                                <th>Name-Surname</th>
                                                <th>Reason</th>
                                                <th>Remark</th>
                                                <th>Activity Date</th>
                ...
                if(result){
                    ...
                    if(result.total_Daily || result.total_Monthly || result.total_Daily_Monthly){
                        ...
                        if(result.total_Daily.new_basic_wage_proposed > 0){
                            var cal_daily = (parseFloat(result.total_Daily.new_basic_wage_proposed)/parseFloat(result.total_Daily.current_salary_wage)-1)*100;
                        }else{
                            var cal_daily = 0;
                        }
                        if(result.total_Monthly.new_salary_wage_month > 0){
                            var cal_month = (parseFloat(result.total_Monthly.new_salary_wage_month)/parseFloat(result.total_Monthly.current_salary_wage_month)-1)*100;
                        }else{
                            var cal_month = 0;
                        }
                        if($('#search_month_day').val() == '1'){
