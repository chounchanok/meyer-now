                                            ...
                                            <div class="row g-3 mb-3" style="font-size: 14px;">
                                                ...
                                                <div class="col-12 col-sm-2" style="font-size: 14px;">
                                                    <label
                                                        ...
                                                        >Group</label
                                                    >
                                                    <select class="form-select myLike" data-control="select2" id="search_group" name="search_group" data-placeholder="-Select-" onchange="destroy_table();">
                                                ...
                                                @else
                                                    <input type="hidden" class="form-select myLike" id="search_group" name="search_group" value="all">
                                                @endif
                                                ...
                                                <div class="col-12 col-sm-2" style="font-size: 14px;">
                                                    <label
                                                        ...
                                                        >Grade</label
                                                    >
                                                    <select class="form-select myLike" data-control="select2" id="search_grade" name="search_grade[]" data-close-on-select="false" data-placeholder="All" data-allow-clear="true" multiple="multiple" onchange="destroy_table();">
                            ...
                            <div class=" position-relative">
                                ...
                                >
                                    ...
                                    <div class="d-inline-flex">
                                        <button type="button" class="btn btn-danger rotate p-2 ps-3 rounded-pill" style="font-size:14px;" onclick="cancel_approve();"><i class="bi bi-arrow-counterclockwise fs-5"></i>{{__('Cancel Item')}}</button>
                                    </div>
                                    <div class="d-inline-flex">
                                    ...
                                    <div class="d-inline-flex">
                                        <button type="button" class="btn btn-primary rotate p-2 ps-3 rounded-pill" style="font-size:14px;" onclick="sendmail_jd();"><i class="bi-file-earmark-excel fs-5"></i>Send E-mail (JD)</button>
                                    </div>
                                    <div class="d-inline-flex">
                                        <button type="button" class="btn btn-primary rotate p-2 ps-3 rounded-pill" style="font-size:14px;" onclick="export_excel_jd();"><i class="bi-file-earmark-excel fs-5"></i>Export Excel (JD)</button>
                                    </div>
                                    <div class="d-inline-flex" style="font-size: 14px !important;">
                                ...
                                <table class="table table-striped table-rounded">
                                    <thead class="table-light">
                                        <tr class="text-center fw-bold align-middle">
                                            <th>Monthly/Daily</th>
                                            <th class="bg-light-warning" id="footer-vis-click-28">Current B. Salary/Wage</th>
                                            <th class="bg-light-warning" id="footer-vis-click-29">L800 AVG. Wage of Min.Wage Adjusted</th>
                                            <th class="bg-light-warning" id="footer-vis-click-30">B. Salary/Wage for Calculation</th>
                                            <th class="bg-light-warning" id="footer-vis-click-31">Current B. Salary/Wage (THB/Mth)</th>
                                            <th class="bg-light-warning" id="footer-vis-click-32">Company Suggested (%)</th>
                                            <th class="bg-light-warning" id="footer-vis-click-33">Company Suggestged (Amount)</th>
                                            <th class="bg-light-warning" id="footer-vis-click-34">Company Suggestged New Basic</th>
                                            <th></th>
                                            <th class="bg-primary" id="footer-vis-click-36" style="color:white;">Inc. % Proposed by Mgr.</th>
                                            <th class="bg-primary" id="footer-vis-click-37" style="color:white;">Inc. Amount Proposed by Mgr.</th>
                                            <th class="bg-primary" id="footer-vis-click-38" style="color:white;">New Basic/Wage Proposed by Mgr.</th>
                                            <th class="bg-primary" id="footer-vis-click-39" style="color:white;">New B. Salary/Wage (THB/Mth)</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-sm-12 hide_exiting_position" style="display:none;">
                            <label
                                for="exampleFormControlInput1"
                                class="form-label mb-0"
                                ></label
                        ...
                        <div class="col-12 col-sm-12 hide_new_position" style="display:none;">
                            <label
                                for="exampleFormControlInput1"
                                class="form-label mb-0"
                                ></label
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-sm-12">
                            <label
                                ...
                                >New position</label
                            >
                            <select class="form-select form-select-solid" id="change_position_new_info" name="change_position_new_info" data-control="select2" data-dropdown-parent="#update_grade_p_info" data-placeholder="-Choose-" disabled>
                                    <option value="0">- Select -</option>
                                @foreach ($position as $key => $val)
                                    <option value="{{ $val->position_code }}">{{ $val->position_code }} - {{ $val->position_description }}</option>
                                @endforeach   
                        ...
                        <div class="col-12 col-sm-12">
                            <label
                                ...
                                >Job Description</label
                            >
                            <textarea class="form-control" name="change_position_remark_info" id="change_position_remark_info" cols="30" rows="10" disabled></textarea>
                        </div>
                        <div class="col-12 col-sm-12 showhide_change_position_reasons_info" style="display:none;">
                            ...
                            >
                            <textarea class="form-control" name="change_position_reasons_info" id="change_position_reasons_info" cols="20" rows="10" disabled></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #231950;color: white;">
                    <h3 class="modal-title" style="color: white;"><i class="ki-solid ki-pencil fs-5"></i> Read a job Description</h3>
                    <div
                        class="btn btn-icon btn-sm btn-active-light-primary ms-2"
                        data-bs-dismiss="modal"
                        aria-label="Close"
                    ...
                    <div class="row g-3 mb-3">
                        <div class="row col-12 col-sm-9">
                            <div class="col-12 col-sm-4 mt-4">
                                ...
                                <select class="form-select form-select-solid" id="jd_position" name="jd_position" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                            ...
                            <div class="col-12 col-sm-4 mt-4">
                                ...
                                <input type="text" class="form-control form-control-solid" id="jd_position_description" name="jd_position_description" disabled>
                            </div>
                            <div class="col-12 col-sm-4 mt-4">
                                <label class="form-label mb-0">3) Company</label>
                                <select class="form-select form-select-solid" id="jd_company" name="jd_company" data-placeholder="-Choose-" disabled>
                            ...
                            <div class="col-12 col-sm-4 mt-3">
                                ...
                                <select class="form-select form-select-solid" id="jd_level" name="jd_level" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                            ...
                            <div class="col-12 col-sm-4 mt-3">
                                ...
                                <select class="form-select form-select-solid" id="jd_division" name="jd_division" onchange="get_department_jd();" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                                      
                                </select>
                            </div>
                            <div class="col-12 col-sm-4 mt-3">
                                <label class="form-label mb-0">6) Department</label>
                                <select class="form-select form-select-solid" id="jd_department" name="jd_department" onchange="get_section_jd();" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                                    <option value="0">เลือก</option> 
                                </select>
                            </div>
                            <div class="col-12 col-sm-4 mt-4">
                                <label class="form-label mb-0">7) Section</label>
                                <select class="form-select form-select-solid" id="jd_section" name="jd_section" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                                    <option value="0">เลือก</option>    
                                </select>
                            </div>
                            <div class="col-12 col-sm-4 mt-4">
                                <label class="form-label mb-0">8) Position Backup</label>
                                <select class="form-select form-select-solid" id="jd_position_backup" name="jd_position_backup" data-control="select2" data-dropdown-parent="#update_jd" data-placeholder="-Choose-" disabled>
                                    <option value="0">เลือก</option> 
                                    @foreach ($position_jd as $key => $val)
                                        <option value="{{ $val->position_code }}">{{ $val->position_description }}</option>
                                    @endforeach   
                            ...
                            <div class="col-12 col-sm-12 mt-4 setheight_jd">
                                ...
                                <select class="form-select form-select-solid" id="jd_position_report" name="jd_position_report[]" data-control="select2" data-dropdown-parent="#update_jd" data-close-on-select="false" data-placeholder="Choose" data-allow-clear="true" multiple="multiple" disabled>
                                    <option value="0">เลือก</option> 
                                    @foreach ($position_jd as $key => $val)
                        ...
                        <div class="col-12 col-sm-3" style="border: 2px solid #d7d7d7;border-radius: 8px;padding: 0px;">
                            ...
                            <div class="col-12 col-sm-12" style="padding: 10px;">
                                ...
                                <select class="form-select form-select-solid" id="jd_organization_position" name="jd_organization_position" data-control="select2" data-dropdown-parent="#update_jd" mutiple data-placeholder="-Choose-" disabled>
                                    <option value="0">เลือก</option> 
                                    @foreach ($position_jd as $key => $val)
                                        <option value="{{ $val->position_description }}">{{ $val->position_description }}</option>
                                    @endforeach   
                            ...
                            <div class="col-12 col-sm-12" style="padding: 10px;">
                                ...
                                <select class="form-select form-select-solid" id="jd_organization_level" name="jd_organization_level" data-control="select2" data-dropdown-parent="#update_jd" mutiple data-placeholder="-Choose-" disabled>
                                    <option value="0">เลือก</option> 
                                    @foreach ($position_jd as $key => $val)
                                        <option value="{{ $val->position_description }}">{{ $val->position_description }}</option>
                                    @endforeach   
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center align-middle">
                                                ...
                                                <input type="text" id="KEY_RESPONSIBILITY" name="KEY_RESPONSIBILITY" class="form-control" value="Recruitment" disabled>
                                            ...
                                            <tr class="text-center align-middle">
                                                <td  style="padding: 10px;">
                                                    ...
                                                    <div class="rowKnowledge_jd_0" style="display: flex;align-items: center;justify-content: center;margin-bottom: 10px;">
                                                        <input type="text" id="rowKnowledge_jd_0" name="KNOWLEDGE[]" class="form-control" disabled>
                                            ...
                                            <tr class="text-center align-middle">
                                                <td  style="padding: 10px;">
                                                    ...
                                                    <div class="rowSkills_jd_0" style="display: flex;align-items: center;justify-content: center;margin-bottom: 10px;">
                                                        <input type="text" id="rowSkills_jd_0" name="SKILLS[]" class="form-control" disabled>
                                            ...
                                            <tr class="text-center align-middle">
                                                <td  style="padding: 10px;">
                                                    ...
                                                    <div class="rowPersonality_jd_0" style="display: flex;align-items: center;justify-content: center;margin-bottom: 10px;">
                                                        <input type="text" id="rowPersonality_jd_0" name="PERSONALITY_TRAITS[]" class="form-control" disabled>
    ...
    <script type="text/javascript">
        ...
        function search_data(){
            ...
            var otable = $("#kt_datatable_dom_positioning").DataTable({
                ...
                ajax: {
                    url: "{{ url(Request::segment(1).'/table_approve_salary_getdata') }}",
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: function(d) {
                        ...
                        if($('#search_grade').val().length > 0){
                            d.search_grade = $('#search_grade').val();
                        }  
                        if($('#search_group').val().length > 0){
            ...
            $(".toggle-vis").change(function (e) {
                ...
                if(toggle_vis_all1_final != ""){
                    ...
                    const resultxx = cut_toggle_vis_all1_final.includes('40');
                    if(resultxx){
                        $("#toggle-vis-click-final-40").prop("checked", true);
                        let column = otable.column(40);
                        column.visible(true);
                    }else{
                        $("#toggle-vis-click-final-40").prop("checked", false);
                        let column = otable.column(40);
                        column.visible(false);
                    }
                }else{
                ...
                if(toggle_vis_all1_remark != ""){
                    ...
                    const resultxx = cut_toggle_vis_all1_remark.includes('41');
                    if(resultxx){
                        $("#toggle-vis-click-remark-41").prop("checked", true);
                        let column = otable.column(41);
                        column.visible(true);
                    }else{
                        $("#toggle-vis-click-remark-41").prop("checked", false);
                        let column = otable.column(41);
                        column.visible(false);
                    }
                }else{
            ...
            //     for (let index = 23; index <= 27; index++) {
            //         $('.toggle-vis').each(function(e) {
            //             if(e == index){
            //                 $('#toggle-vis-click-'+e).click();
            //             }           
            ...
            //     for (let index = 29; index <= 34; index++) {
            //         $('.toggle-vis').each(function(e) {
            //             if(e == index){
            //                 $('#toggle-vis-click-'+e).click();
            //             }           
            ...
            all_detail();
            var get_toggle_vis_all1 = localStorage.getItem("toggle_vis_all1");
            var xtoggle_all7 = localStorage.getItem("toggle_all7");
            var get_toggle_vis_all1 = localStorage.getItem("toggle_vis_all1");
            var toggle_vis_all1_final = localStorage.getItem("toggle_vis_all1_final");
            var toggle_vis_all1_remark = localStorage.getItem("toggle_vis_all1_remark");
            ...
            if(get_toggle_vis_all1 != ""){
                var cut_get_toggle_vis_all1 = get_toggle_vis_all1.split(',');
                for (let columnIdxx = 1; columnIdxx <= 39; columnIdxx++) {
            ...
            //             if(element != ""){
            //                 if(xtoggle_all7 == 'false'){
            //                     if(element != '35' && element != '36' && element != '37' && element != '38' && element != '39' && element != '40' && element != '41'){
            //                         // console.log(element);
            ...
            if(e.value == 'P' || e.value == 'AR' || e.value == 'U' || e.value == 'CD'){
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#change_position_new').val(result.position_code_change);
                        $('#select2-change_position_old-container').text(result.position_code+' - '+result.position_description);
                        $('#select2-change_position_new-container').text(result.position_code_change+' - '+result.position_description_change);
            ...
            if(e == 'P' || e == 'AR' || e == 'U' || e == 'CD'){
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#change_position_old_info').val((result.position_code?result.position_code:result.position_code));
                        $('#change_position_new_info').val(result.position_code_change);
                        $('#select2-change_position_old_info-container').text((result.position_code?result.position_code:result.position_code)+' - '+(result.position_description?result.position_description:result.position_description));
                        $('#select2-change_position_new_info-container').text(result.position_code_change+' - '+result.position_description_change);
        ...
        function all_detail(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url(Request::segment(1)."/all_detail_approve") }}',
                dataType: 'json',
                data : { 
                    "_token": "{{ csrf_token() }}",
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (result) { 
                                window.location.href = "{{ url(Request::segment(1).'/orisoft_excel') }}/"+search_month_day+","+activity_date+","+search_year;
                                destroy_table2();
                            }
                        });
                    }
            ...
            // }else{
                $.ajax({
                    ...
                    success: function (result) { 
                        ...
                        // }
                        result.data.forEach(element => {
                            html += `<option value="${element.section_code}">${element.section_code}</option>`;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if(search_month_day == 'all'){
                        window.location.href = "{{ url(Request::segment(1).'/export_excel_approve/') }}"+"?search_division="+search_division+"&search_department="+search_department+"&search_section="+search_section+"&search_employee_no="+search_employee_no+"&search_month_day="+search_month_day+"&search_grade="+search_grade+"&search_status="+search_status+"&pagenow="+pagenow+"&pagenow_salary=1&search_year="+search_year+"&search_group="+search_group;
                    }else if(search_month_day == '1'){
                        window.location.href = "{{ url(Request::segment(1).'/export_excel_day_approve/') }}"+"?search_division="+search_division+"&search_department="+search_department+"&search_section="+search_section+"&search_employee_no="+search_employee_no+"&search_month_day="+search_month_day+"&search_grade="+search_grade+"&search_status="+search_status+"&pagenow="+pagenow+"&pagenow_salary=1&search_year="+search_year+"&search_group="+search_group;
                    }else{
                        window.location.href = "{{ url(Request::segment(1).'/export_excel_month_approve/') }}"+"?search_division="+search_division+"&search_department="+search_department+"&search_section="+search_section+"&search_employee_no="+search_employee_no+"&search_month_day="+search_month_day+"&search_grade="+search_grade+"&search_status="+search_status+"&pagenow="+pagenow+"&pagenow_salary=1&search_year="+search_year+"&search_group="+search_group;
                    }
                }
            });
        }
        function export_excel_jd(){
            var search_division = $('#search_division').val();
            var search_department = $('#search_department').val();
            var search_section = $('#search_section').val();
            var search_employee_no = $('#search_employee_no').val();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ url(Request::segment(1).'/export_excel_approve_jd/') }}"+"?search_division="+search_division+"&search_department="+search_department+"&search_section="+search_section+"&search_employee_no="+search_employee_no+"&search_month_day="+search_month_day+"&search_grade="+search_grade+"&search_status="+search_status+"&pagenow="+pagenow+"&pagenow_salary=1&search_year="+search_year+"&search_group="+search_group;
        ...
        function cancel_approve(){
            ...
            if(getCheckbox.length == 0){
                ...
                Swal.fire({
                    title: "{{ __('The system will cancel all items listed in the current table in order to send the data back to DM/GM.') }}",
                    text: "{{ __('Do you want to confirm?') }}",
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '{{ url(Request::segment(1)."/cancel_approve") }}',
                            dataType: 'json',
                            data : { 
                                "_token": "{{ csrf_token() }}",
                                "id":getCheckbox,
        ...
        function sendmail_jd(){
            Swal.fire({
                title: "{{ __('Do you want to confirm?') }}",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url(Request::segment(1)."/sendmail_jd") }}',
                        dataType: 'json',
                        data : { 
                            "_token": "{{ csrf_token() }}",
                            "search_division":$('#search_division').val(),
        ...
        function open_jd(i,id,employee_id) {
            var id_gmgr = $('#hidden_grade_proposed'+id).val();
            console.log(id_gmgr);
            if(id_gmgr == 'P'){
                $.ajax({
                        type: 'POST',
