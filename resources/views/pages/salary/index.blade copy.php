<x-default-layout>
    ...
    {{ Breadcrumbs::render('salary.index') }}
    @endsection
                ...
                <div class="card-body pt-6">
                    ...
                    <div class="d-black d-md-none" style="display:none;">
                        <div>
                            ...
                            <button
                                ...
                                data-bs-target="#collapseSearchMobile"
                                aria-expanded="false"
                    ...
                    <div class="row g-3 mb-3 d-none d-md-flex">
                        ...
                        <div class="col-md-6 col-xl-2">
                            ...
                            <div
                                class="card shadow-none rounded-3 p-3 bg-light-secondary mb-2"
                            >
                                <div class="d-flex flex-stack">
                                    <div class="symbol symbol-40px me-4">
                                        <div
                                            class="symbol-label fs-2 fw-semibold bg-secondary"
                                        >
                                            <i
                            ...
                            <div
                                class="card shadow-none rounded-3 p-3 bg-light-danger mb-2"
                            >
                                <div class="d-flex flex-stack">
                                    <div class="symbol symbol-40px me-4">
                                        <div
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                <thead class="table-light">
                                    ...
                                    <tr class="fw-bold fs-6 text-gray-800 px-7">
                                        <th class="text-center bg-light-dark">
                                            SL
                                        </th>
                                        <th class="text-center bg-light-dark">
                                        ...
                                        <th class="bg-light-danger text-center">
    ...
    <div class="modal fade" tabindex="-1" id="update_grade_p">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Grade P</h3>
                    <div
                        class="btn btn-icon btn-sm btn-active-light-primary ms-2"
                        data-bs-dismiss="modal"
                        aria-label="Close"
            ...
            $.ajax({
                ...
                success: function (result) {
                    if(result){
                        ...
                        $('.data_in').html(parseFloat(result.data_all)-parseFloat(result.data_finish));
                        if(result.data_reject){
                            $('.data_reject').html(result.data_reject);
                        }
                        if(result.data_finish){
        ...
        function change_position_p(){
            ...
            if($('#change_position_old').val() == "0"){
                ...
                if($('#change_position_new').val() == "0"){
                    ...
                    for(var i = 0;i < hidden_budget_std.length;i++){
                        if(hidden_budget_grade_name[i].value == 'P'){
