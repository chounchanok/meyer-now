        ...
        <div class="col-md-4">
            ...
            <div class="card card-flush h-md-100">
                ...
                <div class="card-footer flex-wrap pt-0">
                    <!-- <a href="{{ route('meyer.user-management.roles.show', [Session::get('meyer'), $role->id]) }}" class="btn btn-light btn-active-primary my-1 me-2">View Role</a> -->
                    @can('edit roles')
