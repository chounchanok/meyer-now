<div class="modal fade" id="kt_modal_update_role" tabindex="-1" aria-hidden="true" wire:ignore.self>
    ...
    <div class="modal-dialog modal-dialog-centered mw-950px">
        ...
        <div class="modal-content">
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mx-5 my-7 mt-0">
                <!--begin::Form-->
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    ...
                                    -->
                                        ...
                                        @foreach ($permissions_by_group as $group => $permissions)
                                            ...
                                            <tr>
                                                <!--begin::Label-->
                                                <td class="text-gray-800">{{ ucwords($group) }}<br><span class="d-flex align-items-center py-2 text-muted">{{ $group }}</span></td>
                                                <!--end::Label-->
                                                <!--begin::Input group-->
