	...
	<div class="card w-100 border-0 rounded-0" id="kt_drawer_chat_messenger">
		...
		<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
			...
			<div class="card-toolbar">
				<!--begin::Menu-->
				<div class="me-0">
					<button type="button" class="btn btn-sm btn-icon btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{!! getIcon('dots-square', 'fs-2') !!}</button>
					<!--begin::Menu 3-->
		...
		<div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-2">
					<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="Coming soon">{!! getIcon('paper-clip', 'fs-3') !!}</button>
					<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="Coming soon">{!! getIcon('cloud-add', 'fs-3') !!}</button>
				</div>
				<!--end::Actions-->
				<!--begin::Send-->
				<button type="button" class="btn btn-primary" type="button" data-kt-element="send">Send</button>
				<!--end::Send-->
			</div>
			<!--end::Toolbar-->
		</div>
